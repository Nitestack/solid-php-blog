...
const Footer: ParentComponent<{ routes: {
    [key: string]: string;
} }> = (props) => {
    return (
        <footer class="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
            <div class="mx-auto max-w-screen-xl text-center">
                ...
                <p class="my-6 text-gray-500 dark:text-gray-400">{Constants.APP_DESCRIPTION}</p>
                ...
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© {new Date().getUTCFullYear()} <Link href="#" class="hover:underline">{Constants.APP_NAME}</Link>. All Rights Reserved.</span>
            </div>
        </footer>
    );
};
